...
<figure markdown="1">
[![Example 1 - Graph of an income distribution similar to that of Howard County, Maryland](http://hecker.files.wordpress.com/2008/10/gini-example-1.png)](http://hecker.files.wordpress.com/2008/10/gini-example-1.png)
</figure>

Now let's look at the graph for our second example from above:

<figure markdown="1">
[![Example 2 - Graph of a more unequal income distribution](http://hecker.files.wordpress.com/2008/10/gini-example-2.png)](http://hecker.files.wordpress.com/2008/10/gini-example-2.png)
</figure>
...
<figure markdown="1">
[![Example 1 - Graph of an income distribution similar to that of Fairfield County, Connecticut](http://hecker.files.wordpress.com/2008/10/gini-example-3.png)](http://hecker.files.wordpress.com/2008/10/gini-example-3.png)
</figure>
